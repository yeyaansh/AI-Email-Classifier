...
// This helper function is correctly placed at the top level.
        ...
        <div className="flex flex-col gap-8 max-w-5xl mx-auto p-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              <label htmlFor="emailCount" className="font-medium text-gray-700">
                Fetch:
              </label>
              <div className="relative">
                ...
                >
                  ...
                  <option valueD={50}>50 Emails</option>
                </select>
